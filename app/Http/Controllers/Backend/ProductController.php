    ...
    public function StoreProduct(Request $request)
    {
        ...
        if ($files = $request->file('file')) {
          ...
          $product_id = Product::insertGetId([
              ...
              'short_desc_en' => $request->short_descp_en,
              'short_desc_hin' => $request->short_descp_hin,
              'long_desc_en' => $request->long_descp_en,
              'long_desc_hin' => $request->long_descp_hin,
          ...
          foreach ($image as $imgs) {
            ...
            Image::make($imgs)->resize(917,1000)->save('upload/products/multi-image/'.$name_gen);
