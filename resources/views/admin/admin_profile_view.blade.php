            ...
            <div class="row">
                ...
                <div class="box box-widget widget-user">
					...
					<div class="widget-user-image">
					  ...
					  <img class="rounded-circle" src="{{ (!empty($adminData->profile_photo_path))? url('upload/admin_imaged/'.$adminData->profile_photo_path):url('upload/no_image.jpg') }}" alt="User Avatar">
					</div>
