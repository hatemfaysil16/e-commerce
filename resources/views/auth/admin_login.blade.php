			...
			<div class="col-lg-4 col-md-5 col-12">
				...
				<div class="p-30 rounded30 box-shadowed b-2 b-dashed">
					...
					<form method="POST" action="{{ isset($guard) ? url($guard.'/login') : route('login') }}">
						...
						<div class="form-group">
							<div class="input-group mb-3">
								...
								<input  class="form-control pl-15 bg-transparent text-white plc-white" id="email" type="email" name="email"  placeholder="Username">
							</div>
						</div>
						<div class="form-group">
							<div class="input-group mb-3">
							...
							<div class="col-6">
								...
								<input type="checkbox" id="remember_me" id="basic_checkbox_1" >
					...
					<div class="text-center">
						<p class="mt-15 mb-0 text-white">Dont have an account? <a href="auth_register.html" class="text-info ml-5">Sign Up</a></p>
					</div>
				</div>
			</div>
		</div>
